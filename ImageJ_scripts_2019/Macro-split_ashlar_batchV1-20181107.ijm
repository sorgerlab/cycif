...
run("Bio-Formats", "open="+filename+" color_mode=Default concatenate_series rois_import=[ROI manager] specify_range view=Hyperstack stack_order=XYCZT series_1 c_begin_1=1 c_end_1=1 c_step_1=1");
